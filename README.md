...
**Input:**
```bash
python -m modules.main --model gpt-oss:20b --max_iterations 3 --ingredients 'rhubarb, rice, duck, tomatoes, sesame seeds, persimmon, and oreos' --allergens gluten --budget 50 --calories 1500 --verbose
```
